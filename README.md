...
| Dashboard   | `apps/dashboard` | `:3000` | [https://playpk.vercel.app](https://playpk.vercel.app) |
...
│   ├── walkin/       # Next.js front-desk walk-in POS (tablet/desktop)
...
Use **four terminals** (or run what you need):

```bash
npm run docker:up        # Postgres :5432 + Redis :6379
npm run dev:api          # http://localhost:4000
npm run dev:dashboard    # http://localhost:3000
npm run dev:walkin       # http://localhost:3001  (front-desk POS)
...
| **Unified portal** | [http://localhost:3000/login](http://localhost:3000/login)   | Customer / Company / Admin (same page) |
| **Walk-in desk**   | [http://localhost:3001/login](http://localhost:3001/login)   | Front desk / company owner             |
| Mobile (optional)  | Expo Metro [http://localhost:8081](http://localhost:8081)    | same player account                    |
...
| --------------- | ----------------------------------------------------- | -------------- | ------------------- |
| Customer 1      | [player@playpk.demo](mailto:player@playpk.demo)       | PlayPK@player1 | `/discover`         |
| Customer 2      | [player2@playpk.demo](mailto:player2@playpk.demo)     | PlayPK@player2 | `/discover`         |
| GameOn owner    | [owner@playpk.demo](mailto:owner@playpk.demo)         | PlayPK@demo1   | `/companies`        |
| 360 Arena owner | [owner360@playpk.demo](mailto:owner360@playpk.demo)   | PlayPK@3601    | `/companies`        |
| Front desk      | [frontdesk@playpk.demo](mailto:frontdesk@playpk.demo) | PlayPK@desk1   | Walk-in app `:3001` |
| Admin           | [admin@playpk.demo](mailto:admin@playpk.demo)         | PlayPK@admin1  | `/admin`            |
...
| `npm run dev:walkin`                                    | Front-desk walk-in POS (`:3001`)                           |
| `npm run dev:mobile`                                    | Expo Metro                                                 |
| `npm run db:migrate`                                    | Prisma migrate (dev)                                       |
| `npm run db:seed`                                       | Seed sports + demo venue                                   |
| `npm run db:sync-supabase-auth --workspace=@playpk/api` | Mirror demo logins into Supabase Auth (needs service role) |
...
- Sports: `/api/sports`
- Pricing: `GET /api/pricing/resolve`, `/api/pricing-rules`, `/api/branding`
- Walk-in POS: `/api/walkin/*` (grid, SSE events, book, day-summary, branding)
...
| Role                    | Email                                                 | Password       |
| ----------------------- | ----------------------------------------------------- | -------------- |
| Customer 1 (player)     | [player@playpk.demo](mailto:player@playpk.demo)       | PlayPK@player1 |
| Customer 2 (player)     | [player2@playpk.demo](mailto:player2@playpk.demo)     | PlayPK@player2 |
| GameOn Sports owner     | [owner@playpk.demo](mailto:owner@playpk.demo)         | PlayPK@demo1   |
| 360 Arena owner         | [owner360@playpk.demo](mailto:owner360@playpk.demo)   | PlayPK@3601    |
| Front desk (GameOn DHA) | [frontdesk@playpk.demo](mailto:frontdesk@playpk.demo) | PlayPK@desk1   |
| Platform admin          | [admin@playpk.demo](mailto:admin@playpk.demo)         | PlayPK@admin1  |


Also seeds **GameOn Sports · DHA Phase 5 (Lahore)** with 5 courts and 7 days of slots, 14 sports, sample branding, and a weekend +20% pricing rule.
...
✅ Company dashboard (analytics, tournaments, pricing rules, branding)  
✅ Walk-in front-desk POS (`apps/walkin`) sharing booking + pricing with online  
