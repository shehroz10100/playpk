...
| **Walk-in desk** | http://localhost:3001/login | Front desk / company owner |
...
| Front desk | frontdesk@playpk.demo | PlayPK@desk1 | Walk-in app `:3001` |
...
| Front desk (GameOn DHA) | frontdesk@playpk.demo | PlayPK@desk1 |
