...
export function Sidebar({ companyId, branchId }: SidebarProps) {
  ...
  const items = [
    ...
    ...(branchId
      ? [
          ...
          {
            href: `/branches/${branchId}/engagement`,
            label: 'Reviews & waitlist',
            icon: Star,
          },
          {
            href: `/branches/${branchId}/tournaments`,
            label: 'Tournaments',
            icon: Trophy,
          },
        ]
    ...
    <>
      <div className="border-b border-white/10 px-5 py-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            <div className="text-lg font-semibold tracking-tight">PlayPK</div>
            <div className="mt-1 text-xs text-white/60">Venue Operating System</div>
          </div>
          <button
            type="button"
      ...
      <div className="border-t border-white/10 p-4">
        <div className="mb-3 truncate text-sm text-white/80">{user?.name ?? 'Staff'}</div>
